defmodule LmapControllerWeb.Router do
  use LmapControllerWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LmapControllerWeb.Layouts, :root}
  ...
  if Application.compile_env(:lmap_controller, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LmapControllerWeb.Telemetry
